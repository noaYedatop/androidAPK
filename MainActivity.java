                        ...
                        if (result.optString("result").indexOf("ashraitReady") > -1){
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if(DOMAIN == "dangot1"){
                                        launch_back.setComponent(new ComponentName("com.Synqpos", "com.credix.pinpaddriverwithandroidusage.MainActivity"));
                                    }
                                    else {
...
//                    response.body().close();
                    ...
                    Intent launch_back = new Intent(activity, MainActivity.class);
                    if (DOMAIN == "dangot1") {
                        it.setComponent(new ComponentName("com.Synqpos", "com.credix.pinpaddriverwithandroidusage.MainActivity"));
                    }
                    else {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.toLowerCase().contains("login")){
                    openLogin(url);
                }else if (url.toLowerCase().contains("main2")) {
//                    openInBrowser(url);
                    openBackOffice(url);
                    return true;
                }
...
//        webView.postUrl("https://office1.yedatop.com/modules/stock/rep_tazmech_print.php?&simple=1&sDate=01/02/2021&eDate=18/02/2021",("zedmode=1&journum=104").getBytes());
    ...
    public class MyJsInterface {
        ...
        public void enableKeyboard() {
            handler.postDelayed(enableKeyboard,300);
...
//            MainActivity.this.webView.setFocusableInTouchMode(true);
        ...
        public void disableKeyboard(){
            MainActivity.this.webView.setDescendantFocusability(FOCUS_BLOCK_DESCENDANTS);
            //MainActivity.this.webView.setFocusable(false);
            MainActivity.this.webView.setFocusableInTouchMode(false);
        }
        @JavascriptInterface
        ...
        public double  getWeight(){
            if (getPlatform() ==  PLATFORMS.iPOS || getPlatform() ==  PLATFORMS.SUNMI)
                return  MainActivity.this.getFromUsbWeight();
