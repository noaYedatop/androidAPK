package com.credix.pinpaddriverwithandroidusage.receiver;
...
public class UsbDeviceReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_USB_PERMISSION.equals(action)) {
            synchronized (this) {
                Log.d(TAG, "UsbManager EXTRA_PERMISSION_GRANTED booleanExtra = " + intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false));
