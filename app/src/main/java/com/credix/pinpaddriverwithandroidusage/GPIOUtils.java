...
public class GPIOUtils {
    ...
    public static String Cash_gpio = "/sys/devices/platform/ryd_gpio_control/cash_open1_cpu";

    public static String Cash_state_gpio_3288 = "/sys/class/gpio/gpio59/value";
    public static String Cash_state_gpio = "/sys/devices/platform/ryd_gpio_control/cash_box_state";
    /**
     * 修改gpio值为b
     * @param b
     * @param fileName
    ...
    {
        File f_red_led = new File(GPIOUtils.Cash_3288);//red led
    ...
    public static void witchStatus_SEC(final byte onff, final String fileName)
    {
        ...
        witchStatus( status,  GPIOUtils.Cash_3288);
        new Thread() {
            public void run() {
                try {
                    Thread.sleep(1000);
                ...
                GPIOUtils.witchStatus(onff,GPIOUtils.Cash_3288);
